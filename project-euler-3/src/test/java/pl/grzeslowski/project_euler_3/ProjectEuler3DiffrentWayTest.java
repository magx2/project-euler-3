...
public class ProjectEuler3DiffrentWayTest {
    private final int in;
    private final long out;

    public ProjectEuler3DiffrentWayTest(final int in, final long out) {
        this.in = in;
        this.out = out;
    }
    ...
    public void test_normal_parameters() {
        ...
        // given
        final ProjectEuler3 euler = new ProjectEuler3DiffrentWay();
